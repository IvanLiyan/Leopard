...
export default class ResponsiblePersonState {
  compliance: LinkProductComplianceType = "EU_COMPLIANCE";
  ...
  async submit() {
    ...
    const ok =
      data?.policy?.productCompliance?.euCompliance?.upsertResponsiblePerson.ok;
    const message =
      data?.policy?.productCompliance?.euCompliance?.upsertResponsiblePerson
        .message;
  ...
  async linkProduct(
    ...
    const ok = data?.policy?.productCompliance?.euCompliance?.upsertLink.ok;
    const message =
      data?.policy?.productCompliance?.euCompliance?.upsertLink.message;
