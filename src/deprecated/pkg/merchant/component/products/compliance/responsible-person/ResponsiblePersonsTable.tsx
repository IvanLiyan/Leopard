...
/* Merchant Components */
import ResponsiblePersonFilter from "@merchant/component/products/compliance/widgets/ResponsiblePersonFilter";
import ResponsiblePersonModal from "@merchant/component/products/compliance/widgets/ResponsiblePersonModal";
  ...
  query ResponsiblePersons_ResponsiblePersonsTable(
    ...
    policy {
      productCompliance {
        ...
        responsiblePersonCount(states: $states, complianceType: EU_COMPLIANCE)
      }
    }
  }
`;
    ...
    <Layout.FlexColumn className={css(className, style)}>
      <Layout.FlexColumn justifyContent="flex-start">
        ...
        <Table data={rpList} noDataMessage={i`No Responsible Persons`}>
          <Table.Column
            _key={undefined}
            columnKey="address.name"
            title={i`Name`}
            width={200}
          />
          <Table.Column _key={undefined} columnKey="id" title={i`Address`}>
          ...
          <Table.Column _key={undefined} columnKey="email" title={i`Email`} />
          <Table.Column
            _key={undefined}
            columnKey="address.phoneNumber"
            title={i`Phone`}
          />
          <Table.Column
            _key={undefined}
