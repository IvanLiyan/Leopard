...
export const MerchantAppWebhookTopicName: {
  ...
  PRODUCT_UPDATE_MERCHANT: i`Product update merchant`,
  PRODUCT_IMAGE_JOB_STATUS_UPDATE: i`Product image job status update`,
  PRODUCT_TAGGING_UPDATE: i`Product tagging update`,
  PRODUCT_INVENTORY_CHANGE_WISH_USER: i`Product inventory change Wish user`,
  PRODUCT_INVENTORY_CHANGE_MERCHANT: i`Product inventory change merchant`,
};
