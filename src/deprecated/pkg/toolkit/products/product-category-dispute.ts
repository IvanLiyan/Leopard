...
export type ProductCategoryDisputeDetailsInitialData = {
  ...
  readonly policy?: {
    readonly productCategoryDispute?: {
      readonly disputes?: ReadonlyArray<PickedProductCategoryDisputeDetailsSchema> | null;
    };
  };
};
...
export type AdminProductCategoryDisputeReviewInitialData = {
  readonly policy?: {
    readonly productCategoryDispute?: {
      readonly disputes?: ReadonlyArray<PickedAdminProductCategoryDisputeDetailsSchema> | null;
    };
  };
};
...
export type ProductCategoryDisputeResponseData = {
  readonly policy: {
    readonly productCategoryDispute?: {
      ...
      readonly disputes?: ReadonlyArray<PickedProductCategoryDisputeSchema> | null;
    } | null;
  };
};
