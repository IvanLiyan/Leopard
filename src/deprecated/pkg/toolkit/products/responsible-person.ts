...
> & {
  ...
  readonly responsiblePersons?: ReadonlyArray<PickedResponsiblePersonInitialData> | null;
};
...
export type ResponsiblePersonsRequestData =
  ProductComplianceSchemaResponsiblePersonsArgs;

export type ResponsiblePersonsResponseData = {
  readonly policy?: {
    readonly productCompliance?: {
      readonly responsiblePersons?: ReadonlyArray<PickedResponsiblePerson> | null;
...
type EuProductComplianceState = Extract<
  LinkProductComplianceState,
  "HAS_RP" | "NO_RP"
>;

export const RpLabel: { [type in EuProductComplianceState]: string } = {
