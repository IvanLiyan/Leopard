...
export type BulkAddEditStep = "SELECT_ACTION" | "UPLOAD_CSV" | "COLUMN_MAPPING";
...
export type ProductCsvInitialData = {
...
export const ActionOptions: ReadonlyArray<Option<ActionType>> =
...
export const PlusActionOptions: ReadonlyArray<Option<PlusActionType>> =
...
export const CsvExampleMap: {
  ...
  UPSERT_PRODUCTS: ExampleMplusAddEditProduct,
  UPSERT_PRODUCTS_NO_SHIP: ExampleMplusAddEditProductNoShip,
...
export type UpsertProductCsvInputType =
  ProductCatalogMutationsUpsertProductCsvFileArgs;
...
export type DownloadAllProductsCsvInputType =
  ProductCatalogMutationsDownloadAllProductsCsvArgs;
