...
import CountryLabel from "@merchant/component/core/CountryLabel";
...
type Props = BaseProps & {
  ...
  readonly canEditPrimaryWarehouse: boolean;
};
      ...
      >
        ...
        >
          {({ row }: CellInfo<DataItem, DataItem>) => (
            <Button
              onClick={() => onEdit(row)}
              disabled={row.unitId === "STANDARD" && !canEditPrimaryWarehouse}
            >
