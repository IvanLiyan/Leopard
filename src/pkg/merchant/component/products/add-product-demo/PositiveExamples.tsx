...
const makeup = "/demo-video-examples/makeup-360-width-muted.mp4";
const cornhole = "/demo-video-examples/cornhole-360-width-muted.mp4";
const desk = "/demo-video-examples/desk-chairs-360-width-muted.mp4";
const organizer = "/demo-video-examples/organizer-360-width-muted.mp4";
const weights = "/demo-video-examples/weights-360-width-muted.mp4";
const workout = "/demo-video-examples/workout-360-width-muted.mp4";
