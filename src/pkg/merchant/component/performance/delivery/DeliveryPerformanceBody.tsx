...
type DeliveryPerformanceBodyProps = BaseProps & {
  readonly performanceData: PerformanceData;
};

const DeliveryPerformanceBody = (props: DeliveryPerformanceBodyProps) => {
  ...
  return (
    <>
      ...
      <div className={css(styles.dataContainer)}>
        <div className={css(styles.policyLabel)}>Confirmed Delivery Rate</div>
...
export default DeliveryPerformanceBody;
