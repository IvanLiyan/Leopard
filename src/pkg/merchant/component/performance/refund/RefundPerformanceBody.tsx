...
type RefundPerformanceBodyProps = BaseProps & {
  readonly performanceData: PerformanceData;
};

const RefundPerformanceBody = (props: RefundPerformanceBodyProps) => {
  ...
  return (
    <>
      <div className={css(styles.dataContainer)}>
        ...
        <div className={css(styles.thresholdValue)}>{`< 5%`}</div>
      </div>
      <div className={css(styles.dataContainer)}>
        <div className={css(styles.policyLabel)}>Refund Rate</div>
        <div className={css(styles.thresholdLabels)}>Warning</div>
        <div className={css(styles.thresholdValue)}>{`> 10%`}</div>
      </div>
    </>
  );
};

export default RefundPerformanceBody;
