...
type CnMerchantTermsOfServiceProps = BaseProps & {
  readonly releaseDate?: Pick<Datetime, "unix">;
};

export default observer((props: CnMerchantTermsOfServiceProps) => {
    ...
    <div className={css(className, style)}>
      <Markdown
        ...
        text={
          ...
          i`merchants who reside in China. (Please find the Merchant Terms of Service ` +
          i`and Agreement for the European Union and the United Kingdom ` +
          i`[here](${euTosUrl}), and the Merchant Terms of ` +
          i`Service and Agreement for anywhere other than China, the European Union, ` +
          i`and the United Kingdom [here](${generalTosUrl}).) **`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`view the previous terms click ` +
          i`[here](${previousTosUrl}).`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`service**” or “**Terms**”) carefully, especially the contents herein in ` +
          i`capitalized or bold text, before using services, including, without ` + // eslint-disable-next-line local-rules/no-hardcoded-wish-link
          i`limitation, the website at https://www.wish.com, the app offered under the ` +
          i`name Wish, and all other websites, apps, and services offered by or ` +
          i`through us pursuant to this Agreement (as defined below) (collectively, ` +
          i`the “**Services**”) offered by ContextLogic Inc. (“**Wish**,” “**we**,” ` +
          i`and “**us**”).  **Unless otherwise agreed to in writing by you and Wish, ` +
          i`by registering (when creating store, you check the box “Accept Terms of ` +
          i`Service” to complete the registration process) for or otherwise using the ` +
          i`Services in any manner, including, but not limited to, visiting or ` +
          i`browsing the Services, it means that you have fully read, understood and ` +
          i`voluntarily accepted these Terms, and agree to be bound by and comply with ` +
          i`these Terms, and all additional terms and conditions  (“Additional Terms”) ` +
          i`and policies and guidelines (“Policies”) referenced herein or published or ` +
          i`made available by Wish, in each case to the extent such Additional Terms ` +
          i`and Policies are applicable to your use of the Services or activities on ` +
          i`the Wish platform, including, without limitation, the following provisions ` +
          i`of these Terms: (a) receiving communications and conducting transactions ` +
          i`electronically, (b) disclaimers of warranties, (c) damage and remedy ` +
          i`exclusions and limitations, (d) binding arbitration, and (e) choice of ` +
          i`California law. **`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`Policies, form the entire agreement between you and Wish (the “Agreement”) ` +
          i`with respect to the subject matter hereof and supersede all prior ` +
          i`agreements. **To the extent that the Terms conflict with any other ` +
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`This Agreement sets forth the legally binding terms and conditions on you ` +
      ...
      <Markdown
        ...
        text={
          ...
          i`due to Wish’s or any of its Affiliates’ negligence.** “**Affiliate**” ` +
          i`shall mean, with respect to any person or entity, any other person or ` +
          i`entity that directly or indirectly controls, is controlled by, or is under ` +
          i`common control with that person or entity.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`submit is accurate and truthful. **Wish may refuse to offer access to or ` +
          i`use of the Services to any person or entity or change its eligibility ` +
          i`criteria at any time as provided herein. **This provision is void where ` +
          i`prohibited by Applicable Laws and the right to access the Services is ` +
          i`revoked in such jurisdictions.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`[Privacy Policy](${wishPrivacyPolicyUrl})`
        }
      />

      <Markdown
        openLinksInNewTab
        text={i`and those Terms of Use and Privacy Policy shall govern such conduct.`}
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`valid payment information such as a valid PayPal account. **You hereby ` +
          i`irrevocably authorize us and relevant cooperated parties, including, ` +
          i`without limitation, third-parity payment agencies or other entities (and ` +
          i`will provide us documentation evidencing your authorization upon our ` +
          i`request) to verify and share your information (including any updated ` +
          i`information), to obtain credit reports about you from time to time, to ` +
          i`obtain credit authorizations from the issuer of your credit card, and, in ` +
          i`limited circumstances, to charge your credit card or debit your bank ` +
          i`account for any sums payable by you to us (in reimbursement or otherwise). ` +
          i`You also agree to provide Wish any additional information or ` +
          i`authorizations as may be necessary for Wish to provide the Services or for ` +
          i`you to fulfill your obligations under this Agreement, including all ` +
          i`applicable Additional Terms and Policies. All payments to you will be ` +
          i`remitted to your bank account through a payment service provider you ` +
          i`designate or by other means specified by us.** Depending on the payment ` +
          i`method you choose, you may be required to provide a valid United States ` +
          i`tax identification number via Form W-9 or proof of residency outside the ` +
          i`United States via Form W-8BEN/W-8BEN-E.`
        }
      />
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`**Right to Refuse Service:** **Wish reserves the right to cancel ` +
          i`unconfirmed or inactive accounts or to refuse to offer the Services to you ` +
          i`for any violation or suspected violation of this Agreement or ` +
          i`Applicable Laws, with or without notice to you.** We may also ` +
          i`discontinue the Services or any part of the Services and delete all data ` +
          i`or other information associated with your account (including any materials ` +
          i`you may submit to us). We assume no liability for any information removed ` +
          i`from the Services, and we reserve the right to permanently restrict access ` +
          i`to the Services or your account. You agree that you do not have any rights ` +
          i`in the Services and that we have no liability to you if the Services are ` +
          i`discontinued or if you are no longer able to access the Services or any ` +
          i`information that was previously made available to you on the Services.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`Payments](${policyFeesUrl}) Policy or as otherwise ` +
          i`communicated to you by Wish.  You understand and agree that Wish’s ` +
          i`obligation to pay you is expressly subject to the terms of and your ` +
          i`compliance with this Agreement and is conditioned upon Wish’s successful ` +
          i`receipt of funds from Wish users who purchase items through the Services.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`[Fees and Payments](${policyFeesUrl}) Policy or as ` +
          i`otherwise communicated to you by Wish, to the payment provider or ` +
          i`processor you have selected (e.g., UMPAY, PayEco, AllPay, Payoneer, PayPal ` +
          i`China, Bill.com, PingPong, or others as may be added or removed from time ` +
          i`to time) irrespective of your receipt of payment from the payment provider ` +
          i`or processor.** Each payment provider or processor may have its own terms ` +
          i`of use or other legal requirements, and Wish does not guarantee and is not ` +
      ...
      <Markdown
        ...
        text={
          ...
          i`Payments](${policyFeesUrl}) Policy or as otherwise ` +
          i`communicated to you by Wish, until such time as Wish receives valid ` +
          i`confirmation of product delivery. Transactions for which Wish cannot ` +
          i`confirm valid delivery may be ineligible for payment and may subject your ` +
          i`account balance to temporary or permanent holds or account suspension.**`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`terms of this Agreement, including any applicable Policies, may result in ` +
          i`their forfeiture. **`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`Wish user.** You further agree that you will provide the purchased ` +
          i`products or services to the Wish user in the agreed-upon manner as if you ` +
          i`have received the payment directly from the Wish user. You agree that Wish ` +
          i`may refund the Wish user in accordance with Wish’s [Return ` +
          ...
          i`items through the Services. **Wish guarantees payments to you only for ` +
          i`such amounts that have been successfully received by Wish from Wish users ` +
          i`in accordance with this Agreement and Wish’s [Terms of ` +
      ...
      <Markdown
        ...
        text={
          ...
          i`Agreement, the [Fees and Payments](${policyFeesUrl}) Policy, ` +
          i`or as otherwise communicated by Wish to you. Your funds are not eligible ` +
          i`for payment to you unless and until all terms in this Agreement, the [Fees ` +
          i`and Payments](${policyFeesUrl}) Policy and Wish’s [Terms of ` +
      ...
      <Markdown
        ...
        text={
          ...
          i`to satisfy any obligation then owing by you to Wish.**  Wish shall ` +
          i`otherwise have no interest in the funds that it holds for you as paying ` +
          i`agent, and any liability for taxation or otherwise related to such funds ` +
          i`shall be entirely yours.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`you become aware of, or reasonably suspect, any nonconformity or defect ` +
          i`in, or safety concerns, or recall related to your products. **If we ` +
          i`determine that the performance of your obligations under this Agreement ` +
          i`may result in returns, claims, disputes, or violations of this Agreement, ` +
          i`or cause any other risks to us or third parties, then we may mitigate ` +
          i`them, including by determining whether a customer will receive a refund, ` +
          i`adjustment, or replacement for any of your products or services for as ` +
          i`long as we determine any related risks to us or third parties persist.**`
        }
      />
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`**If you offer a product for sale through our Services that requires a ` +
          i`warning under California Health & Safety Code Section 25249.6 (a ` +
          i`“Proposition 65 Warning”) you (a) will provide in your listing such ` +
          i`warning in the manner compliant with Applicable Laws, (b) agree that our ` +
          i`display of a Proposition 65 Warning on a product detail page is ` +
          i`confirmation of our receipt of that warning, and (c) will only revise or ` +
          i`remove a Proposition 65 Warning for a product when the prior warning is no ` +
          i`longer legally required.**`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`RIGHTS AND REMEDIES OF A BAILOR ARISING UNDER ANY APPLICABLE LAWS (WHETHER ` +
          i`ARISING UNDER COMMON LAW, CIVIL LAW, STATUE OR OTHERWISE) RELATING TO ANY ` +
          i`POSSESSION, STORAGE, SHIPMENT OR DISPOSAL OF YOUR PRODUCTS BY WISH, OUR ` +
          i`AFFILIATES OR ANY OF OUR OR THEIR DESIGNEES, CONTRACTORS OR AGENTS.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`Union or in the United Kingdom.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`(“**ARBITRATION AGREEMENT**”) CAREFULLY. IT REQUIRES YOU TO ARBITRATE ` +
      ...
      <Markdown
        ...
        text={
          ...
          i`RESOLVED ONLY BY FINAL AND BINDING, BILATERAL ARBITRATION.`
        }
      />
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`You and Wish agree that the law of the State of California of United ` +
          i`States of America, and Hong Kong International Arbitration Centre (HKIAC) ` +
          i`Administered Arbitration Rules in force when a notice of arbitration is ` +
          i`submitted to HKIAC, shall apply to this Arbitration Agreement and govern ` +
          i`all questions as to whether a Dispute is subject to arbitration.`
        }
      />
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`No party shall be entitled to commence or maintain any action in a court ` +
          i`of law upon any matter in dispute until such matter has been submitted and ` +
          i`determined as provided here, and then only for the enforcement of such ` +
          i`arbitration award. Notwithstanding this mediation and arbitration policy, ` +
          i`either party may apply to a court of competent jurisdiction as necessary ` +
          i`to enforce an arbitration award, or to seek a temporary restraining order ` +
          i`or preliminary injunction to ensure that the relief sought in arbitration ` +
          i`is not rendered ineffectual during the pendency of, or after the rendition ` +
          i`of, a decision in any arbitration proceeding. The institution of any ` +
          i`action shall not constitute a waiver of the right or obligation of any ` +
          i`party to submit any claim seeking relief other than injunctive or ` +
          i`enforcement relief to arbitration. Further, any party seeking to enforce ` +
          i`an award of an arbitrator(s) shall submit the award under seal to maintain ` +
          i`protections of confidential information, and you and Wish hereby agree and ` +
          i`consent to the filing of such a submission, motion, or order under seal.`
        }
      />
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`Except as provided herein, if we cannot resolve a Dispute informally, any ` +
          i`Dispute, including any dispute, controversy, difference or claim arising ` +
          i`out of or relating to this Agreement, including the existence, validity, ` +
          i`interpretation, performance, breach or termination thereof or any dispute ` +
          i`regarding non- contractual obligations arising out of or relating to it, ` +
          i`shall be referred to and finally resolved by arbitration administered by ` +
          i`the Hong Kong International Arbitration Centre (HKIAC) under the HKIAC ` +
          i`Administered Arbitration Rules in force when the Notice of Arbitration is ` +
          i`submitted.`
        }
      />
      ...
      <ul>
        <li>
          <Markdown
            openLinksInNewTab
            text={
              i`The law of this arbitration clause shall be the law of the State of ` +
              i`California, United States of America.`
            }
          />
        </li>
        ...
        <li>
          <Markdown
            openLinksInNewTab
            text={i`The seat of arbitration shall be Hong Kong.`}
          />
        </li>
        ...
        <li>
          <Markdown
            openLinksInNewTab
            text={
              i`The number of arbitrators shall be three. The arbitration proceedings ` +
              i`shall be conducted in English.`
            }
          />
        </li>
      </ul>
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`Any arbitration will be filed with and administered by HKIAC under the ` +
          i`HKIAC Administered Arbitration Rules, which are available at the HKIAC ` +
          i`website at hkiac.org.  If there is a conflict between the HKIAC ` +
          i`Administered Arbitration Rules and the rules set forth in this Arbitration ` +
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`Notwithstanding the HKIAC Administered Arbitration Rules, the following ` +
          i`will apply to all arbitration actions:`
        }
      />
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`In addition to the foregoing and notwithstanding the HKIAC Administered ` +
          i`Arbitration Rules, certain procedures will apply depending on the amount ` +
          i`in controversy. For controversies and claims in which the amount in ` +
          i`controversy is **less than $1,000,000.00** (one million dollars), the ` +
          i`Expedited Procedure will apply with the following amendment:`
        }
      />
      ...
      <ul>
        <li>
          <Markdown
            openLinksInNewTab
            text={
              i`There will be one arbitrator selected from the HKIAC Panel of Arbitrators, ` +
              i`using the HKIAC Administered Arbitration rules for arbitrator selection.`
            }
          />
        </li>
        ...
        <li>
          <Markdown
            openLinksInNewTab
            text={
              i`The tribunal shall institute discovery consistent with the goals of ` +
              i`arbitration. Discovery and disclosure of information will be conducted to ` +
              i`achieve the usual goals of arbitration, including cost effective and ` +
              i`efficient resolution of disputes between parties.`
            }
          />
        </li>
      </ul>
      ...
      <ul>
        <li>
          <Markdown
            openLinksInNewTab
            text={
              i`There will be three (3) arbitrators selected from the HKIAC Panel of ` +
              i`Arbitrators, using the HKIAC Administered Arbitration rules for arbitrator ` +
              i`selection.`
            }
          />
        </li>
        ...
        <li>
          <Markdown
            ...
            text={
              ...
              i`HKIAC Administered Arbitration Rules.`
            }
          />
        </li>
      </ul>
      ...
      <Markdown
        ...
        text={
          ...
          i`hearing under the HKIAC Administered Arbitration Rules, solely based on ` +
          i`documents submitted to the arbitrator.`
        }
      />
      ...
      <Markdown
        openLinksInNewTab
        text={
          i`Wish shall bear the cost of any arbitration fees if so decided by the ` +
          i`tribunal. You are responsible for all other additional costs that you may ` +
          i`incur in the arbitration including, without limitation, attorneys’ fees ` +
          i`and expert witness costs unless Wish is specifically required to pay such ` +
          i`fees under Applicable Laws.`
        }
      />
      ...
      <h4>
        The parties agree and understand that maintaining confidentiality of
        Disputes and Dispute resolution is of the utmost importance, and agree
        that Wish has valuable trade secrets and proprietary and confidential
        information. The parties agree to take all necessary steps to protect
        from public disclosure such trade secrets and proprietary and
      ...
      <Markdown
        ...
        text={
          ...
          i`IN COURT AND HAVE A TRIAL IN FRONT OF A JUDGE OR A JURY. You and Wish are ` +
          i`instead electing that all covered claims and Disputes shall be resolved by ` +
          i`arbitration under this Arbitration Agreement. There is no judge or jury in ` +
          i`arbitration, and court review of an arbitration award is subject to very ` +
          i`limited review.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`[merchant_notices@wish.com](${merchantNoticesEmail}), within ` +
          i`thirty (30) days after first becoming subject to this Arbitration ` +
          i`Agreement.** Your notice must include your name and address, your Wish ` +
          i`User ID (if any), Wish Merchant ID, the email address you used to set up ` +
          i`your Wish account (if you have one), and a clear statement that you want ` +
          i`to opt out of this Arbitration Agreement. If you opt out of this ` +
          i`Arbitration Agreement, all other parts of this Agreement will continue to ` +
          i`apply to you and Wish reserves the right to terminate the entirety of the ` +
          i`Agreement. Opting out of this Arbitration Agreement has no effect on any ` +
          i`other arbitration agreements that you may currently have with us, or may ` +
          i`enter into in the future with us.`
        }
      />
      ...
      <Markdown
        ...
        text={
          ...
          i`against any present or future parent, subsidiary, or Affiliate of Wish ` +
          i`(including, without limitation, Shanghai Wish Network Technology Co., ` +
          i`Ltd.(Chinese Name: 上海薇仕网络科技有限公司) and Shenzhen Weishi Logistics Network ` +
          i`Technology Co., Ltd.(Chinese Name: 深圳威狮物流网络科技有限公司)), or any employee, ` +
          i`officer, director, or investor of Wish, and to any claims asserted by any ` +
          i`of them against you, to the extent that any such claims arise out of or ` +
          i`relate to this Agreement (such as with respect to their validity or ` +
          i`enforceability), the Services, any person’s access to or use of the ` +
          i`Services, or the provision of Content, products, services, or technology ` +
          i`on or through the Services.**`
        }
      />
