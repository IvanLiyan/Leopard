  ...
  return (
    <PolicySubSection
      title={
        ...
        i`an order with excessively delayed confirmed delivery`
      }
    ...
    >
      <p>
        ...
        calendar days after the order is released to the merchant, the merchant
        is responsible for {100}% of the cost of the refund.
      </p>
