...
const Section5 = ({
  ...
  return (
    <PolicySubSection
      title={
        i`Orders that are not confirmed fulfilled by the carrier ` +
    ...
    >
      <span>
        {i`If an order is not confirmed fulfilled by the carrier within the ` +
      ...
      <ul>
        <li>
          ...
          less than {formatCurrency(100, "USD")}* that are not confirmed
          fulfilled within {168} hours of the order being released will be
          penalized.
        </li>
        <li>
          Orders where (merchant price per item + shipping price per item) is
          greater than or equal to {formatCurrency(100, "USD")}* that are not
          confirmed fulfilled within {336} hours of the order being released
          will be penalized.
        </li>
      </ul>
      <p>
