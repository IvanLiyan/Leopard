...
const Section9 = ({
  ...
  return (
    ...
    >
      <p>
        The Order Cancellation Penalty Policy is effective for orders released
        after October 17, 2018 5PM Pacific Time.
      </p>
      ...
      <p>
        Addendum: Effective October 31, 2018 5PM Pacific Time, merchants are
        allowed to dispute these penalties within {3} business days after a
        penalty statement is generated.
      </p>
