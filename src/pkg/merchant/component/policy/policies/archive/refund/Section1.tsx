  ...
  return (
    <PolicySubSection
      title={
        ...
        i`before the order is confirmed shipped`
      }
      subSectionNumber={`${sectionNumber}.1`}
      currentSection={currentSection}
    >
      <p>
        If an order is refunded before the order is confirmed shipped, the order
        is not eligible for payment. To be eligible for payment, the order must
        be confirmed shipped on Wish before the refund occurs.
      </p>
