  ...
  return (
    <PolicySubSection
      title={
        ...
        i`items not delivered to the customer`
      }
      subSectionNumber={`${sectionNumber}.17`}
      currentSection={currentSection}
    >
      <p>
        If an item’s tracking information marks the item as “delivered”, but the
        customer did not receive the item, the merchant is responsible for
