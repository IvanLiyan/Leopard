...
export type PlatinumMerchantStandingModalProps = BaseProps;

@observer
class PlatinumMerchantStandingModalContent extends Component<
  PlatinumMerchantStandingModalProps
> {
  @computed
  get styles() {
      ...
      <div className={css(this.styles.root)}>
        ...
        <div className={css(this.styles.topSection)}>
          ...
          <div className={css(this.styles.explanation)}>
            {LocalizationStore.instance().locale == "zh"
              ? "您的店铺具有卓越的用户体验表现和政策合规性。"
              : i`Your store ` +
                i`has demonstrated excellent customer experience ` +
        ...
        <div className={css(this.styles.bottomSection)}>
          ...
          <ul className={css(this.styles.list)}>
            ...
            <li className={css(this.styles.listItem)}>
              <Markdown
                text={
                  LocalizationStore.instance().locale == "zh"
                    ? "您店铺内的产品每月最多可获得**5百万**个流量。"
                    : i`Your store’s products are eligible for up` +
                      ` to **5M** additional impressions per month.`
                }
              />
            </li>
            <li className={css(this.styles.listItem)}>
          ...
          <div className={css(this.styles.question)}>
            How do I maintain my Merchant Standing?
          </div>
          <ul>
            <li className={css(this.styles.listItem)}>
...
export default class PlatinumMerchantStandingModal extends Modal {
  ...
  constructor(props: PlatinumMerchantStandingModalProps) {
    super((onClose) => <PlatinumMerchantStandingModalContent {...props} />);
    this.setHeader({
