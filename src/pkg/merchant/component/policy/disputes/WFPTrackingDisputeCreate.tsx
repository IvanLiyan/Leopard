...
type WFPTrackingDisputeCreateProps = BaseProps & {
  ...
  readonly wfpRequiredDeliveryDate?: string | null | undefined;
...
> {
  ...
  get fulfillmentDateValidator() {
    ...
    return new DateSanityValidator({
      ...
      requiredDeliveryDate: wfpRequiredDeliveryDate || "",
    });
  }
    ...
    return [
      {
        ...
        fineAmount,
        policy: i`Warehouse Fulfillment Policy`,
        link: "",
      },
    ];
  }
      ...
      <div>
        <Card className={css(this.styles.card)}>
          <div className={css(this.styles.cardTitle)}>
            Warehouse Fulfillment Policy Tracking Dispute
          </div>
          <HorizontalField
          ...
          <div className={css(this.styles.warningBox)}>
            <Alert
              text={
                ...
                i`the information provided. If the order was ` +
...
export default WFPTrackingDisputeCreate;
