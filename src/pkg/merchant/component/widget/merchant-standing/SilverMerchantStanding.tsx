...
export type SilverMerchantStandingProps = BaseProps;

@observer
export default class SilverMerchantStanding extends Component<
  SilverMerchantStandingProps
> {
        ...
        <div className={css(this.styles.content)}>
          ...
          <div className={css(this.styles.topSection)}>
            ...
            <div className={css(this.styles.explanation)}>
              ...
              <section>
                Your store has demonstrated good customer experience performance
