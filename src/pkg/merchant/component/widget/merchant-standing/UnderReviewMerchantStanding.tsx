...
export type UnderReviewMerchantStandingProps = BaseProps;

@observer
export default class UnderReviewMerchantStanding extends Component<
  UnderReviewMerchantStandingProps
> {
      ...
      <Card className={css(this.styles.root)}>
        <div className={css(this.styles.content)}>
          ...
          <div className={css(this.styles.topSection)}>
            ...
            <Text weight="regular" className={css(this.styles.currentStanding)}>
              Under review
            </Text>
