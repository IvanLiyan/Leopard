...
export type ActiveMerchantStandingProps = BaseProps;

@observer
export default class ActiveMerchantStanding extends Component<
  ActiveMerchantStandingProps
> {
      ...
      <Card className={css(this.styles.root)}>
        <div className={css(this.styles.content)}>
          ...
          <div className={css(this.styles.topSection)}>
            ...
            <div className={css(this.styles.currentStanding)}>Active</div>
