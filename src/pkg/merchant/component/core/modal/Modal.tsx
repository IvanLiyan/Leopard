...
type ModalContainerProps = BaseProps & {
  ...
  readonly canCloseFromOutsideClick: boolean;
};
...
class ModalContainer extends Component<ModalContainerProps> {
  ...
  handleOutsideClick = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    const {
      props: { onClose, canCloseFromOutsideClick },
      contentRef,
    } = this;
    if (contentRef == null || !canCloseFromOutsideClick) {
      return;
    }
...
export default class Modal {
  ...
  setCanCloseFromOutsideClick(canCloseFromOutsideClick: boolean): this {
    this.canCloseFromOutsideClick = canCloseFromOutsideClick;
    return this;
  }
        ...
        (
          <ApolloProvider client={client}>
            <ModalContainer
              ...
              canCloseFromOutsideClick={this.canCloseFromOutsideClick}
            >
              <Content />
            </ModalContainer>
          </ApolloProvider>
