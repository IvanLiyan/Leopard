...
export type CommerceStore = {
  ...
  readonly regular_hours_list: ReadonlyArray<string>;
  ...
  readonly hours_regular_str: string;
  readonly hours_special_str: string;
...
export type AutocompletePrediction = {
  ...
  readonly structured_formatting: {
    ...
    readonly main_text_matched_substrings: ReadonlyArray<
      AutocompleteSubstringMatch
    >;
