...
export type CollectionsProduct = {
  ...
  readonly drop_percentage?: string;
...
export type CollectionsBoostPriceDropExistingOverlap = {
  readonly price_drop_record_id: string;
  readonly product_id: string;
...
export type CollectionsBoostApiCampaign = {
  ...
  readonly price_drop_enabled: boolean;
  readonly products_with_overlapped_price_drop_records: ReadonlyArray<
    CollectionsBoostPriceDropExistingOverlap
  >;
  readonly campaign_drop_percentage: number;
};
...
export type CollectionsBoostCampaignStats = {
  ...
  readonly attributed_tile_impressions?: number;
  readonly search_term_stats: ReadonlyArray<
    CollectionsBoostCampaignSearchTermStat
  >;
