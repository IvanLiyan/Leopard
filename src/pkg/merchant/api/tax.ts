...
export type GermanyNoNumberReason = CommerceMerchantTaxInfoGermanyNoNumberReason;
...
export type UpdateTaxSettingsParams = {
  ...
  readonly country_of_domicile: CountryCode;
  // JSON string
  readonly standard_ship_from_cc_by_destination?: string | null | undefined;
  // JSON string
  readonly express_ship_from_cc_by_destination?: string | null | undefined;
  // JSON string
  readonly ship_from_cc_by_destination?: string | null | undefined;
};
...
export const setTaxSettings = (
  args: UpdateTaxSettingsParams
): MerchantAPIRequest<UpdateTaxSettingsParams, UpdateTaxSettingsResponse> =>
  new MerchantAPIRequest("tax-settings/set", args);
