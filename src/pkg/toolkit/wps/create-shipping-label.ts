...
export const LengthOptions: ReadonlyArray<Option<
  PickedLengthUnit
...
export const roundPackageDimension = (dimension?: number | null | undefined) =>
  dimension == null ? undefined : _.round(dimension, 2);
...
> & {
  ...
  readonly availableAdditionalServiceOptions: ReadonlyArray<
...
export type GetShippingOptionsRequestType = Pick<
  FulfillmentSchemaWpsShippingOptionsArgs,
  "orderId"
>;
...
export type SubmitShippingAddressInputType = FulfillmentMutationEditShippingAddressesArgs;
...
export type ChangePreferredUnitsInputType = MerchantMutationChangePreferredUnitsArgs;
...
export type SubmitDimensionsInputType = ProductCatalogMutationsUpdateProductLogisticsMetadataArgs;
...
export type SubmitShippingOptionInputType = FulfillmentMutationSelectWpsShippingOptionArgs;
...
export type EditShippingOptionInputType = FulfillmentMutationModifyWpsTrackingIdArgs;
...
export type ModifyTrackingOrdersInputType = FulfillmentMutationModifyTrackingOrdersArgs;
