...
type PickedGbVatInfo = Pick<TaxSettingUkDetails, "gbVatEntity">;
...
> & {
  ...
  readonly mexicoDetails: Pick<
    ...
    "defaultShipFromIsMx"
  > | null;
  readonly ukDetails?: PickedGbVatInfo | null;
};
...
export type TaxSettingsInitialDataType = {
  ...
  readonly currentMerchant: {
    ...
    readonly taxIdentification?: TaxIdentificationType | null;
  };
...
export type GBMerchantIndividualNumberOptions = "VAT" | "TIN" | "NIN";
...
export const GBNumberDisplayNameInfo: GBNumberDisplayNameInfoType = {
  ...
  NIN: {
    title: i`National Insurance Number (NIN)`,
    desc:
...
export type UpsertTaxSettingsRequestType =
  TaxSettingsMutationsUpsertTaxSettingsArgs;

export type TaxIdentificationType = Pick<
  MerchantTaxIdentificationSchema,
  | "firstName"
  | "lastName"
  | "businessName"
...
> & {
  ...
  readonly lastUpdated: Pick<Datetime, "formatted">;
};
