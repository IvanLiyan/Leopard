...
export default class NavigationStore {
  ...
  // isNavyBlueNav =
  //   typeof window !== "undefined" && (window as any).userGraph != null;
  ...
  //   (window as any).pageParams.initialContainer;
  ...
  // onPopState(event: undefined | null | PopStateEvent): void {
  ...
  //   void this.navigate(fullPath, {
  //     push: false,
  //   });
  // }

  // pushPath(path: string, queryParams?: any | null | undefined): void {
  //   let query = "";
  //   if (queryParams) {
  ...
  // extractPathAndParams(url: string): {
  ...
  instance(): NavigationStore {
    throw "NavigationStore Not Implemented";
  }
}
