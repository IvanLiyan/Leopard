...
const ShippingAddressModalContent: React.FC<ShippingAddressModalProps> = observer(
  ({
    orderId,
    onClose,
    shippingDetails,
    ...
    return (
      <Layout.FlexColumn alignItems="stretch">
        <Layout.FlexColumn className={css(styles.content)} alignItems="stretch">
          <Layout.FlexColumn className={css(styles.form)} alignItems="stretch">
            ...
            <Layout.FlexRow className={css(styles.row)}>
              <HorizontalField
                ...
                titleAlign="start"
                className={css(styles.item)}
                popoverContent={!streetAddress1 ? shippingAddressTooltip : null}
              >
