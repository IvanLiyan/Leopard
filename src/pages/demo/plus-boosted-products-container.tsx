...
import { PlusBoostedProductsContainer } from "@plus/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query PlusBoostedProductsContainer {
query PlusBoostedProductsContainer_InitialQuery {
  currentMerchant {
    signupTime {
      unix
    }
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <PlusBoostedProductsContainer initialData={initialData} />
    </>
  );
};
