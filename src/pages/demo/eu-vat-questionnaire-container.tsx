...
import { EuVatQuestionnaireContainer } from "@merchant/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query EuVatQuestionnaireContainer {
query EuVatQuestionnaireContainer_InitialQuery {
    platformConstants {
        euVatCountries {
            code
            name
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <EuVatQuestionnaireContainer initialData={initialData} />
    </>
  );
};
