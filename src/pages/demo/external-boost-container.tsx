...
import { ExternalBoostContainer } from "@merchant/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query ExternalBoostContainer {
query SocialAdsBoostContainer_InitialData {
    marketing {
        currentMerchant {
            offsiteBoost {
                chargingMethod
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <ExternalBoostContainer initialData={initialData} />
    </>
  );
};
