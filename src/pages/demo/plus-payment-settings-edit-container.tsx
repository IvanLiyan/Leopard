...
import { PlusPaymentSettingsEditContainer } from "@plus/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query PlusPaymentSettingsEditContainer {
  payments {
    currentMerchant {
      personalInfo {
        name,
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <PlusPaymentSettingsEditContainer initialData={initialData} />
    </>
  );
};
