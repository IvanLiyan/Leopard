...
import { FulfillmentSettingsContainer } from "@merchant/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query FulfillmentSettingsContainer {
query FulfillmentSettingsContainer_InitialContainer {
  currentMerchant {
    state
    vacation {
      startDate {
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <FulfillmentSettingsContainer initialData={initialData} />
    </>
  );
};
