...
import { FBWShippingCreationContainerV2 } from "@merchant/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query FBWShippingCreationContainerV2 {
query FBWShippingCreationContainerV2_InitialData {
  currentMerchant {
    fulfilledByWish {
      availableWarehousesForShippingPlanSubmission {
        id
        code
        region
        name
        ...
        estimatedFulfillTime {
          days
        }
        maxWeight {
          kg: value(targetUnit: KILOGRAM)
        }
        feeLink
      }
    }
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <FBWShippingCreationContainerV2 initialData={initialData} />
    </>
  );
};
