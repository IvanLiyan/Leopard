...
import { TaxSettingsV2Container } from "@merchant/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query TaxSettingsV2Container {
query TaxSettingsV2Container_InitialQuery {
  currentUser {
    entityType
    accountManager {
      name
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <TaxSettingsV2Container initialData={initialData} />
    </>
  );
};
