...
import { BulkFulfillHistoryContainer } from "@plus/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query BulkFulfillHistoryContainer {
fulfillment {
  csvFulfillmentJobsCount
}
}`;
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <BulkFulfillHistoryContainer initialData={initialData} />
    </>
  );
};
