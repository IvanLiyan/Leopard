...
import { PlusAccountSettingsContainer } from "@plus/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query PlusAccountSettingsContainer {
  platformConstants {
    interselectablePhoneCountries {
      code
    }
  }
  currentUser {
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <PlusAccountSettingsContainer initialData={initialData} />
    </>
  );
};
