...
import { RefundAssuranceContainer } from "@merchant/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query RefundAssuranceContainer {
query RefundAssuranceContainer_InitialQuery {
  marketing {
    currentMerchant {
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <RefundAssuranceContainer initialData={initialData} />
    </>
  );
};
