...
import { PlusPaymentSettingsContainer } from "@plus/container";
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const query = gql`
query PlusPaymentSettingsContainer {
  payments {
    currentMerchant {
      personalInfo {
        name,
...
const Page: NextPage<Props> = (
  ...
  return (
    <>
      ...
      <PlusPaymentSettingsContainer initialData={initialData} />
    </>
  );
};
