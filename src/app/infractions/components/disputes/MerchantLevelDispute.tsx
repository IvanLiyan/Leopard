...
import {
  SubmitMerchantDisputeMutationResponse,
  SubmitMerchantDisputeMutationVariables,
  SUBMIT_MERCHANT_DISPUTE_MUTATION,
} from "@infractions/api/submitMerchantDisputeMutation";
  ...
  return (
    <Accordion defaultExpanded title={i`Dispute Details`}>
      ...
      <ModalFooter
        action={
          canDispute
            ? { text: i`Submit`, onClick: onSubmit, isDisabled: loading }
            : undefined
        }
        cancel={{
          text: i`Cancel`,
