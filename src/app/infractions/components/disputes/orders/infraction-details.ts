...
export const INFRACTION_DISPUTE_QUERY = gql`
  query InfractionDispute_InfractionDetails(
    ...
    policy {
      dispute {
        trackingDispute {
          disputes(query: $query, states: $states, searchType: $searchType) {
            state
            id
            createDate {
              formatted(fmt: "M/d/YYYY h:mm a z")
...
export const DisputeStateLabel: {
  ...
  AWAITING_ADMIN: ci18n("Awaiting review", "Awaiting review"),
  AWAITING_MERCHANT: ci18n("Awaiting merchant", "Awaiting merchant"),
  APPROVED: ci18n("Approved", "Approved"),
  CANCELLED: ci18n("Cancelled", "Cancelled"),
  DECLINED: ci18n("Declined", "Declined"),
};
