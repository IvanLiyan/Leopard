...
export const ReasonText: {
  ...
  OTHER: i`Other`,
  INCORRECT_CONFIRMED_DELIVERY_DATE_FROM_CARRIER: ci18n(
    "The confirmed delivery date is inaccurate from what the carrier website shows",
    "The confirmed delivery date is inaccurate from what the carrier website shows",
  ),
};
...
export const ReasonOptions: {
  ...
  ORDER_NOT_DELIVERED: ["INCORRECT_CONFIRMED_DELIVERY_DATE_FROM_CARRIER"],
};
