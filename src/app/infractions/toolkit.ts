...
const getDeprecatedInfractionData = (title: string): Datum => ({
  title,
...
const TaggingViolationSubReasonCodeData: {
  readonly [reason in TaggingViolationSubReasonCode]: Partial<Datum> & {
...
const CounterfeitReasonData: {
  readonly [reason in CounterfeitReason]: Partial<Datum>;
} = {
  SAFETY_EQUIPMENT: {
